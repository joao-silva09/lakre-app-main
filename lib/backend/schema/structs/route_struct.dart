...
class RouteStruct extends FFFirebaseStruct {
  ...
  set companyPhone(String? val) => _companyPhone = val;
  ...
  int get hashCode => const ListEquality()
      .hash([routeId, expectedArrivalDt, isAccepted, companyPhone, stops]);
}
